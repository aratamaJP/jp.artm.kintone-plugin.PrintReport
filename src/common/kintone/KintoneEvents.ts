...
export const KintoneEvents = {
    ...
    Detail: {
        ...
        Proceed : ["app.record.detail.process.proceed", "mobile.app.record.detail.process.proceed"],
    },
    ...
    Create: {
        ...
        SubmitSuccess: ["app.record.create.submit.success", "mobile.app.record.create.submit.success"],
    ...
    Edit: {
        ...
        SubmitSuccess: ["app.record.edit.submit.success", "mobile.app.record.edit.submit.success"],
